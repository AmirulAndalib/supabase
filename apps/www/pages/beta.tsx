...
// Dark text: text-scale-1400
// Light text: text-scale-1300
      ...
      <div className="grid items-center grid-cols-12 col-span-12 border-b border-dashed border-dark-300 dark:border-dark-400 sm:border-r">
        {segments.flat().map((segment: any) => (
          <div
            ...
            className={`
              text-scale-1300 dark:text-scale-1400 dark:bg-scale-1600 hover:bg-scale-1100 dark:hover:bg-scale-1500 border-dark-300 dark:border-dark-400 col-span-12 cursor-pointer border-t border-dashed
              bg-white px-4 py-4 sm:border-l lg:col-span-4 lg:px-6 lg:py-10`}
          >
            <p className="flex items-center text-black dark:text-white">
              <span className="mr-2 font-mono text-xs text-scale-1300 dark:text-scale-1400">
                0{segment.no}
              </span>
  ...
  return (
    <div className="p-2 rounded-xl bg-gradient-to-r from-green-400 via-violet-500 to-blue-500">
      <div className="rounded-md shadow-lg" style={{ height: 'fit-content' }}>
        <div className="flex items-center justify-start w-full h-5 px-2 bg-scale-1400 rounded-t-md">
          <div className="w-2 h-2 mr-2 rounded-full bg-scale-1500" />
          <div className="w-2 h-2 mr-2 rounded-full bg-scale-1500" />
          <div className="w-2 h-2 mr-2 rounded-full bg-scale-1500" />
        </div>
...
const Hero = (props: Props) => {
  ...
  return (
    ...
    >
      <div className="container grid items-center h-full grid-cols-12 gap-4 px-8 py-20 mx-auto text-scale-1300 lg:px-28">
...
const Introduction = () => {
  return (
    <div className="container grid grid-cols-12 gap-4 px-8 py-20 mx-auto text-scale-1300 lg:px-28">
      ...
      >
        {AlphaNumbers.map((stat: any, idx: number) => (
          ...
          >
            ...
            <div className="col-span-7 sm-col-span-8 text-scale-1400 md:col-span-9 xl:col-span-10">
...
const TableOfContents = (props: any) => {
  const { scrollTo } = props
  return (
    <div className="dark:bg-scale-300 text-scale-1400 dark:text-scale-1200 bg-gray-50">
...
const Performance = () => {
    ...
    return (
      <div id="performanceCharts">
        {PerformanceComparisonData.map((metric: any) => {
          ...
          return (
            <div key={`${metric.key}`} className="mb-10 text-scale-1400 dark:text-scale-1300">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center">
                      ...
                      <Bar
                        color={
                          stat.name === 'Supabase'
                            ...
                            : 'bg-scale-1300 dark:bg-scale-1400'
                        }
                ...
                <div className="flex flex-col text-left sm:w-1/6 sm:text-right">
                  <p className="text-6xl text-scale-1700 dark:text-scale-1100">{multiplier}x</p>
  ...
  return (
    <div id="performance" className="bg-white dark:bg-scale-200">
      <div className="container grid grid-cols-12 px-8 py-20 mx-auto text-scale-1400 dark:text-scale-1300 gap-y-10 lg:px-28">
        ...
        <div className="grid items-center grid-cols-12 col-span-12 mb-10 text-scale-1200 gap-x-2 lg:gap-x-8">
          <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
            ...
            <p className="text-scale-1400 dark:text-scale-1300">
...
const Security = () => {
  return (
    <div id="security" className="dark:bg-scale-300 bg-gray-50">
      <div className="container grid grid-cols-12 px-8 py-20 mx-auto text-scale-1400 dark:text-scale-1200 gap-y-10 lg:px-28">
...
const Reliability = () => {
  return (
    <div id="reliability" className="bg-white dark:bg-scale-200">
      <div className="container grid grid-cols-12 px-8 py-12 mx-auto text-scale-1400 dark:text-scale-1300 gap-y-10 lg:px-28 ">
