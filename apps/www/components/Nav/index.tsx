      ...
      <div className="mb-3 flex md:h-full lg:flex-col">
        ...
        <div className="ml-4 md:flex md:flex-1 md:flex-col md:justify-between lg:ml-0 lg:mt-4">
          <div>
            ...
            <p className="text-scale-1100 dark:text-scale-1100 mt-1 text-sm">{description}</p>
          </div>
          {url && (
              ...
              <div className="flex items-center">
                ...
                <div className="hidden pl-4 sm:ml-6 sm:space-x-4 lg:flex">
                  ...
                  <Link href="/pricing">
                    <a
                      className={`
                        text-scale-1200 hover:text-brand-900 hover:border-brand-900 dark:text-scale-1100 dark:hover:border-dark-100 inline-flex items-center
